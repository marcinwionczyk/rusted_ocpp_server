...
impl RpcErrorData {
    ...
    pub fn std(code: i32) -> Self {
        match code {
            ...
            -32700 => RpcErrorData::new(-32700, "Parse error"),
            // The JSON sent is not a valid Request object.
            -32600 => RpcErrorData::new(-32600, "Invalid Request"),
            // The method does not exist / is not available.
            -32601 => RpcErrorData::new(-32601, "Method not found"),
            // Invalid method parameter(s).
            -32602 => RpcErrorData::new(-32602, "Invalid params"),
            // Internal JSON-RPC error.
            -32603 => RpcErrorData::new(-32603, "Internal error"),
...
impl error::Error for RpcErrorData {}
impl fmt::Display for RpcErrorData {
